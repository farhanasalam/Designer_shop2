...
if (isset($_POST['submit'])) {
    ...
    $md_name = $_POST['md_name'];
      ...
      move_uploaded_file($_FILES['md_image']['tmp_name'],"images/uploads/".$material_img);
      $material_img2=$_FILES['md_image']['name'];



  $sql11 = "INSERT INTO `models`(`md_name`,`md_img`,) VALUES ('$md_name','$md_img')";
    $result11 = mysqli_query($conn, $sql11) or die(mysqli_error($conn));

  $imageid = "SELECT `md_id` FROM `models` WHERE `md_name`='md_name' and `md_image`='$md_img' ";
                        ...
                        <li class="active">
                            <a class="has-arrow" href="index.html">
								...
								<ul class="submenu-angle" aria-expanded="true">
										<li><a title="index.php" href="addd.php"><span class="mini-sub-pro">Add Dress</span></a></li>
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <div class="review-content-section">
                                                    <div class="input-group mg-b-pro-edt">
                                                        ...
                                                        <input type="text" name="m_name"class="form-control" placeholder="First Name">
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
