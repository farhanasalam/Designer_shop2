...
require 'connect.php';
echo $qry5="SELECT di.*,de.*,c.*,d.*,s.*,ca.* ,i.* from image as i,disdetails as di,cart as ca,city as c,district as d,state as s,designed as de WHERE i.im_id=de.im_id and di.read_id=ca.read_id and ca.read_id=de.read_id and c.c_id=di.c_id and s.st_id=d.st_id and d.dis_id=c.dis_id and c.status=1" ;
        ...
        <nav id="sidebar" class="">
            ...
            <li>
                ...
                <ul class="submenu-angle" aria-expanded="false">
									...
									<li><a title="View Mail" href="Home.php"><span class="mini-sub-pro">Home</span></a></li>
...
<th>  Product Name</th>
 ...
 <form action="#" method="post">
      <tr>
        ...
        <!--</center></td>-->
<td><center><?php echo $rest1[15];?></center></td>
...
<td><center><?php echo $rest1[9];?></center></td>
<td><center><?php echo $rest1[3];?></center></td>
<td><center><?php echo $rest1[4];?></center></td>
<td><center><?php echo $rest1[6];?></center></td>
<td><center><?php echo $rest1[7];?></center></td>
<td><center><?php echo $rest1[8];?></center></td>
<td><center><?php echo $rest1[20];?></center></td>
<td><center><?php echo $rest1[25];?></center></td>
<td><center><?php echo $rest1[28];?></center></td>
