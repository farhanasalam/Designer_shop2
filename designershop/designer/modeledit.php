...
$price=$_POST['price'];
echo $k="select img_id from models where desi_id=$rid";
	$sk=mysqli_query($conn,$k);
	$sks=mysqli_fetch_array($sk);

      	$image=$sks['img_id'];
              $material_img1=$_FILES['img1']['name'];
                move_uploaded_file($_FILES['img1']['tmp_name'],"images/uploads/".$material_img1);
                $material_img2=$_FILES['img2']['name'];
                  move_uploaded_file($_FILES['img2']['tmp_name'],"images/uploads/".$material_img2);
                  $material_img3=$_FILES['img3']['name'];
                    move_uploaded_file($_FILES['img3']['tmp_name'],"images/uploads/".$material_img3);

                        $sql="UPDATE `image2` SET `img1`='$material_img1', `img2`='$material_img2',`img3`='$material_img3'  WHERE `img_id`='$image'";

          							mysqli_query($conn,$sql);

          						    $img_id=mysqli_insert_id($conn);
           mysqli_query($conn,"UPDATE `models` SET `img_id`='$image',`md_name`='$md_name',`price`='$price' WHERE `md_int`='$rid'");
                    ...
                    <ul class="metismenu" id="menu1">
                        <li class="active">
                            <a class="has-arrow" href="index.html">
								   ...
								   <span class="mini-click-non">Add </span>
								</a>
								...
								<ul class="submenu-angle" aria-expanded="false">
										<li><a title="X-Editable" href="index.php"><span class="mini-sub-pro">Home</span></a></li>
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="review-tab-pro-inner">
                              ...
                              echo  $qry5="SELECT mo.md_int,mo.md_name,mo.price,i.img1,i.img2,i.img3,i.img_id
                                        FROM image2 as i,models as mo
                                        where   mo.img_id=i.img_id and mo.desi_id='$rid'" ;
						...
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
								<div class="review-content-section">
										<div class="input-group mg-b-pro-edt">
												...
												<input type="text" name="md_name"class="form-control" placeholder="Name">
										</div>
										<div class="input-group mg-b-pro-edt">
												<span class="input-group-addon"><i class="icon nalika-edit" aria-hidden="true"></i></span>
												<input type="file" name="img1" class="form-control" placeholder="Product Title">
										</div>
										<div class="input-group mg-b-pro-edt">
												<span class="input-group-addon"><i class="fa fa-usd" aria-hidden="true"></i></span>
												<input type="file" name="img2" class="form-control" placeholder="Regular Price">
										</div>
										<div class="input-group mg-b-pro-edt">
												<span class="input-group-addon"><i class="icon nalika-new-file" aria-hidden="true"></i></span>
												<input type="file" name="img3"class="form-control" placeholder="Tax">
										</div>
										<div class="input-group mg-b-pro-edt">
												<span class="input-group-addon"><i class="icon nalika-user" aria-hidden="true"></i></span>
				...
				<div class="row">
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
								<div class="text-center custom-pro-edt-ds">
										<input type="submit" name="submit" class="btn btn-ctl-bt waves-effect waves-light m-r-10">
</button>
<?php }?>
