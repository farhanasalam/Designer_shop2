...
$price=$_POST['price'];
  $img1=$_FILES['img1']['name'];
      move_uploaded_file($_FILES['img1']['tmp_name'],"images/uploads/".$img1);
      // $material_img2=$_FILES['md_img']['name'];
			$img2=$_FILES['img2']['name'];
		      move_uploaded_file($_FILES['img2']['tmp_name'],"images/uploads/".$img2);

					$img3=$_FILES['img3']['name'];
				      move_uploaded_file($_FILES['img3']['tmp_name'],"images/uploads/".$img3);
							$sql11 = "INSERT INTO `image2`(`img1`,`img2`, `img3`,`desi_id`,`status`) VALUES ('$img1','$img2','$img3','$id',0)";
								$result11 = mysqli_query($conn, $sql11) or die(mysqli_error($conn));

							$imageid = "SELECT `img_id` FROM `image2` WHERE`img1`='$img1' and `img2`='$img2' and `img3`='$img3'and `desi_id`='$id'";
							 $result22 = mysqli_query($conn, $imageid);

							 while ($row = mysqli_fetch_array($result22)) {
								$b = $row["img_id"];

  $sql12 = "INSERT INTO `models`(`md_name`,`img_id`,`desi_id`,`price`) VALUES ('$md_name','$b','$id','$price')";
    $result12= mysqli_query($conn, $sql12) or die(mysqli_error($conn));

  $imageid1 = "SELECT `md_id` FROM `models` WHERE `md_name`='$md_name' and `img_id`='$b' and `price`='$price' and`desi_id`='$id'";
   $result23= mysqli_query($conn, $imageid1);
