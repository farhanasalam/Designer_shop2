...
<td><center><?php echo $rest1['type'];?></center></td>
 ...
 <td>
            ...
            <a href="materialedit.php?id=<?php echo $rest1["read_id"];?>" data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>&nbsp;&nbsp;
