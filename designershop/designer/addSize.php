...
{
    $na=$_POST["size"];
  $k="ALTER TABLE dsize ADD COLUMN $na  INT DEFAULT 0";
    $d=mysqli_query($conn,$k);

  $f="insert into sizechart (sizechart) values('$na')";
  $KS=mysqli_query($conn,$f);
                  ...
                  <li><a title="Compose Mail" href="index.php"><span class="mini-sub-pro">Home</span></a></li>
                         ...
                         <li><a title="Compose Mail" href="usercart.php"><span class="mini-sub-pro">Usercart</span></a></li>
								...
								<ul class="submenu-angle" aria-expanded="false">
									 ...
									 <li><a title="Pdf Viewer" href="Home"><span class="mini-sub-pro">Home</span></a></li>
                                            ...
                                            <ul class="nav navbar-nav mai-top-nav header-right-menu">
                                                ...
                                                <li class="nav-item">
                                                    <a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle">
															...
															<span class="admin-name">Designer</span>
                                                    ...
                                                    <ul role="menu" class="dropdown-header-top author-log dropdown-menu animated zoomIn">
                                                        ...
                                                        <li><a href="myprofile.php"><span class="icon nalika-diamond author-log-ic"></span> my profile</a>
                                                        </li>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <div class="text-center custom-pro-edt-ds">
                                                    <input type="submit" name="Submit"class="btn btn-ctl-bt waves-effect waves-light m-r-10" value="Add">
														</button>
