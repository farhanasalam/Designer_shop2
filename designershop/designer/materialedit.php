...
if (isset($_POST['submit'])) {
    ...
    $price = $_POST['price'];
		echo 	$k="select im_id from designed where read_id=$rid";
			$sk=mysqli_query($conn,$k);
			$sks=mysqli_fetch_array($sk);
		$image=$sks['im_id'];

    // $image=$_POST['im_id'];
    // $material_img1 = time().".jpg";
    $material_img1=$_FILES['image1']['name'];
      move_uploaded_file($_FILES['image1']['tmp_name'],"images/uploads/".$material_img1);
      $material_img2=$_FILES['image2']['name'];
        ...
        echo      $sql="UPDATE `image` SET `image1`='$material_img1' , `image2`='$material_img2' , `image3`='$material_img3'  WHERE `im_id`='$image'";

							mysqli_query($conn,$sql);

						    $im_id=mysqli_insert_id($conn);
 mysqli_query($conn,"UPDATE `designed` SET `type_id`='$type', `im_id`='$image',`color_id`='$color',`m_name`='$m_name',`quantity`='$quantity',`price`='$price' WHERE `read_id`='$rid'");
...
// $rid=$_GET["id"];
$qry5="SELECT de.read_id,de.m_name,de.quantity,de.price,i.image1,i.image2,i.image3,c.color,t.type ,i.im_id
        FROM color as c,type as t,image as i,designed as de
        where de.color_id=c.color_id and de.type_id=t.type_id and de.im_id=i.im_id and read_id='$rid'" ;
                    ...
                    <ul class="metismenu" id="menu1">
                        <li class="active">
                            <a class="has-arrow" href="index.html">
								   ...
								   <span class="mini-click-non">Add materials</span>
								</a>
								<ul class="submenu-angle" aria-expanded="true">
										<li><a title="index.php" href="index.php"><span class="mini-sub-pro">Home</span></a></li>
									<!--  <li><a title="Dashboard v.2" href="index-1.html"><span class="mini-sub-pro">Dashboard v.2</span></a></li>
										<li><a title="Dashboard v.3" href="index-2.html"> <span class="mini-sub-pro">Dashboard v.3</span></a></li> -->
										<li><a title="Product List" href="addd.php"><span class="mini-sub-pro">Add Designed Dress</span></a></li>
										<li><a title="Product Edit" href="models.php"><span class="mini-sub-pro">Add Models</span></a></li>
										<li><a title="Product Detail" href="addsize.php"><span class="mini-sub-pro">Add Size</span></a></li>
								...
								<ul class="submenu-angle" aria-expanded="false">
									<li><a title="Inbox" href="index.php"><span class="mini-sub-pro">Home</span></a></li>
								...
								<ul class="submenu-angle" aria-expanded="false">
										<li><a title="Google Map" href="medit.php"><span class="mini-sub-pro">MaterialEdit</span></a></li>
                        ...
                        <!-- <li>
                            <a class="has-arrow" href="mailbox.html" aria-expanded="false"><i class="icon nalika-forms icon-wrap"></i> <span class="mini-click-non">View</span></a>
                            <ul class="submenu-angle" aria-expanded="false">
                                <li><a title="Basic Form Elements" href="basic-form-element.html"><span class="mini-sub-pro">Designed view</span></a></li>
                                <li><a title="Advance Form Elements" href="advance-form-element.html"><span class="mini-sub-pro">Models view</span></a></li> -->
                        ...
                        <li>
                            <a class="has-arrow" href="edit.html" aria-expanded="false"><i class="icon nalika-smartphone-call icon-wrap"></i> <span class="mini-click-non">Edit</span></a>
                            <ul class="submenu-angle" aria-expanded="false">
                                    ...
                                    <ul class="mobile-menu-nav">
                                        ...
                                        <li><a data-toggle="collapse" data-target="#others" href="#">Miscellaneous <span class="admin-project-icon nalika-icon nalika-down-arrow"></span></a>
                                            <ul id="others" class="collapse dropdown-header-top">
                                                ...
                                                <li><a href="blog-d
																									details.html">Blog Details</a></li>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <div class="breadcomb-wp">
											...
											<div class="breadcomb-ctn">
												<h2>Add Designed Materials</h2>
												<p>Welcome to Designer shop <span class="bread-ntd"></span></p>
											</div>
										</div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="review-tab-pro-inner">
                                ...
                                <ul id="myTab3" class="tab-review-design">
                                    <li class="active"><a href="#description"><i class="icon nalika-edit" aria-hidden="true"></i> Add imag</a></li>
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <div class="review-content-section">
                                                    <div class="input-group mg-b-pro-edt">
                                                        ...
                                                        <input type="text" name="m_name" value="<?php echo $row['m_name']; ?>" class="form-control" placeholder=" Name">
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="icon nalika-edit" aria-hidden="true"></i></span>
																												<img src="/designershop/designer/images/uploads/<?php echo $row['image3'];?>" width="30" height="30" &nbsp;>
																												<img src="/designershop/designer/images/uploads/<?php echo $row['image2'];?>" width="30" height="30" &nbsp;>
																												<img src="/designershop/designer/images/uploads/<?php echo $row['image3'];?>" width="30" height="30">
																												<input type="file" name="image1" value="<?php echo $row['image1']; ?>"classclass="form-control" placeholder="Product Title">
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="fa fa-usd" aria-hidden="true"></i></span>
																												<input type="file" name="image2" value="<?php echo $row['image2']; ?>"classclass="form-control" placeholder="Regular Price">
																										</div>
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="icon nalika-new-file" aria-hidden="true"></i></span>
																												<input type="file" name="image3" value="<?php echo $row['image3']; ?>"classclass="form-control" placeholder="Tax">
																										</div>
                                                    <div class="input-group mg-b-pro-edt">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <div class="text-center custom-pro-edt-ds">
																									  <input  type="hidden"  name="im_id" value="<?php echo $row['im_id'];?>">
                                                    <input type="submit" name="submit"class="btn btn-ctl-bt waves-effect waves-light m-r-10">Save
														</button>
