...
<head>
  ...
  <body style="background-image:url('fashion.png');background-size:cover;" >
    <!--[if lt IE 8]>
        ...
        <nav id="sidebar" class="">
			...
			<div class="nalika-profile">
				<div class="profile-dtl">
					...
					<h2>Designer <span class="min-dtn">Das</span></h2>
				</div>
                    ...
                    <ul class="metismenu" id="menu1">
                        <li class="active">
                            ...
                            <ul class="submenu-angle" aria-expanded="true">
                                 <li><a title="index.php" href="addd.php"><span class="mini-sub-pro">home</span></a></li> 
                              <!--  <li><a title="Dashboard v.2" href="index-1.html"><span class="mini-sub-pro">Dashboard v.2</span></a></li>
                                <li><a title="Dashboard v.3" href="index-2.html"> <span class="mini-sub-pro">Dashboard v.3</span></a></li> -->
                                <li><a title="Product List" href="addd.php"><span class="mini-sub-pro">Add Dress</span></a></li>
                        ...
                        <li>
                            ...
                            <ul class="submenu-angle" aria-expanded="false">
															<li><a title="View Mail" href="index.php"><span class="mini-sub-pro">home</span></a></li>
                        ...
                        <!-- <li>
                            <a class="has-arrow" href="#" aria-expanded="false"><i class="icon nalika-table icon-wrap"></i> <span class="mini-click-non">VIEW</span></a>
                            <ul class="submenu-angle" aria-expanded="false">
                                <li><a title="Peity Charts" href="productlist.php"><span class="mini-sub-pro">view materials</span></a></li>
                                <li><a title="Data Table" href="modellist.php"><span class="mini-sub-pro">view models</span></a></li>
                            </ul>
                        </li>
                        <li>
                            <a class="has-arrow" href="index.php" aria-expanded="false"><i class="icon nalika-forms icon-wrap"></i> <span class="mini-click-non">Edit</span></a>
                            <ul class="submenu-angle" aria-expanded="false">
                                            ...
                                            <ul class="nav navbar-nav mai-top-nav header-right-menu">
                                                ...
                                                <li class="nav-item">
                                                    ...
                                                    <ul role="menu" class="dropdown-header-top author-log dropdown-menu animated zoomIn">
                                                        ...
                                                        <li><a href="myprofile.php"><span class="icon nalika-user author-log-ic"></span> My Profile</a>
                                                        </li>
                                    ...
                                    <ul class="mobile-menu-nav">
                                        ...
                                        <li><a data-toggle="collapse" data-target="#Pagemob" href="#">Pages <span class="admin-project-icon nalika-icon nalika-down-arrow"></span></a>
                                            <ul id="Pagemob" class="collapse dropdown-header-top">
                                                ...
                                                <li><a href="myprofile.php">Register</a>
                                                </li>
