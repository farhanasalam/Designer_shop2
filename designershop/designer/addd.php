...
$did=$_SESSION['log_id'];
  ...
  $sql11 = "INSERT INTO `image`(`image1`,`image2`, `image3`,`status`) VALUES ('$material_img','$material_img2','$material_img3',0)";
  ...
  $imageid = "SELECT `im_id` FROM `image` WHERE `image1`='$material_img' and `image2`='$material_img2' and `image3`='$material_img3'";
   ...
   $sql1 = "INSERT INTO `designed`(`type_id`,`did` ,`im_id`,`color_id`,
            `m_name`,`quantity`,`price`,`status`)
            VALUES ('$type','$did','$b','$color','$m_name','$quantity',
            '$price',0)";
						...
						for($i=0;$i<count($_POST['sizes']);$i++){
							$sql2 = "INSERT INTO `addsize`(`read_id`, `size_id`)
				             VALUES ('$last_id','$a[$i]')";
                    ...
                    <ul class="metismenu" id="menu1">
                        <li class="active">
                            <a class="has-arrow" href="index.html">
								...
								<ul class="submenu-angle" aria-expanded="false">
										<li><a title="Pdf Viewer" href="index.php"><span class="mini-sub-pro">Home</span></a></li>
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <div class="review-content-section">
                                                    ...
                                                    <div class="input-group mg-b-pro-edt">
                                                        ...
                                                        <input type="file" name="image1" class="form-control" placeholder="Product Title">
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="fa fa-usd" aria-hidden="true"></i></span>
                                                        <input type="file" name="image2" class="form-control" placeholder="Regular Price">
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="icon nalika-new-file" aria-hidden="true"></i></span>
                                                        <input type="file" name="image3"class="form-control" placeholder="Tax">
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
