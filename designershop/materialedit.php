          ...
          move_uploaded_file($_FILES['image3']['tmp_name'],"images/uploads/".$material_img3);
            ...
            echo  $sql="UPDATE `image` SET `image1`='$material_img1', `image2`='$material_img2',`image3`='$material_img3'  WHERE `im_id`=$image";
						    ...
						    $im_id=mysqli_insert_id($conn);
								echo $f="UPDATE `designed` SET `type_id`='$type', `im_id`='$im_id',`color_id`='$color',`m_name`='$m_name',`quantity`='$quantity',`price`='$price' WHERE `read_id`='$rid'";
 mysqli_query($conn,$f);
...
// $rid=$_GET["id"];
echo $qry5="SELECT de.read_id,de.m_name,de.quantity,de.price,i.image1,i.image2,i.image3,c.color,t.type ,i.im_id
