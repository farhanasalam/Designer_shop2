...
$pt=$qty*$price;
	...
	$sql="INSERT INTO `cart`(`log_id` ,`read_id`, `qty`,`price`,`status`) values('$id','$rid','$qty','$pt',0)";
	$res=mysqli_query($conn,$sql);

	 $b="UPDATE designed  SET quantity=quantity-$qty WHERE `read_id`='$rid'";
	 $res3 = mysqli_query($conn, $b);
...
<?php
require 'connect.php';
 $qry5="SELECT de.read_id,de.m_name,de.quantity,de.price,i.image1,i.image2,i.image3,c.color,t.type FROM color as c,type as t,image as i,designed as de where de.color_id=c.color_id and de.type_id=t.type_id and de.im_id=i.im_id and de.read_id=$rid";
				...
				<div class="span8">
					<div class="account pull-right">
						<ul class="user-menu">
							...
							<li><a href="disdetails">Checkout</a></li>
			...
			<section class="navbar main-menu">
				<div class="navbar-inner main-menu">
					...
					<nav id="menu" class="pull-right">
						<ul>
							<li><a href="./products.php">Readymades</a>
								<!-- <ul>
			...
			<section class="main-content">
				<div class="row">
					<div class="span9">
						<div class="row">
							<div class="span4">
								<a href="/designershop/designer/images/uploads/<?php echo $rest1['image1'];?>" class="thumbnail" data-fancybox-group="group1" title="Description 1"><img alt="" src="/designershop/designer/images/uploads/<?php echo $rest1['image1'];?>"></a>
								<ul class="thumbnails small">
									<li class="span1">
										<a href="/designershop/designer/images/uploads/<?php echo $rest1['image2'];?>" class="thumbnail" data-fancybox-group="group1" title="Description 2"><img src="/designershop/designer/images/uploads/<?php echo $rest1['image2'];?>" alt=""></a>
									</li>
									<li class="span1">
										<a href="/designershop/designer/images/uploads/<?php echo $rest1['image3'];?>" class="thumbnail" data-fancybox-group="group1" title="Description 3"><img src="/designershop/designer/images/uploads/<?php echo $rest1['image3'];?>" alt=""></a>
									</li>
							...
							<div class="span5">
								<address>
									<strong>Model:<?php echo $rest1['m_name'];?></span><br>
										<strong>Size:</span>
									<?php
									$k="SELECT * from addsize as a,size as s where read_id=$rid and a.size_id=s.size_id";
$ks=mysqli_query($conn,$k);
?>
<select id="ads_id" name="ads_id">
<?php
while($f=mysqli_fetch_array($ks)){
	?>
...
<?php
					...
					?>
									...
									<strong>Type:<?php echo $rest1['type'];?></strong><br>
								<!-- </address> -->
									<!-- <input type="text" hidden name="price" value=""> -->


										<h4>	<strong>Price: <?php echo $rest1['price'];?></strong></h4>
							</div>
							<div class="span5">
								...
								$s=$rest1['quantity'];
									...
									<button class="btn btn-inverse" name="submit" type="submit">Add to cart</button>
								</form>
							</div>
						</div>
					<?php } ?>
