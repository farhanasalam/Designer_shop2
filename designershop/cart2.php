...
require 'connect.php';
 $r="select sum(price) as f from allselect where log_id=$logid and status=0";
...
// require 'connect.php';
 $qry5="SELECT  al.price as uprice,al.*,mo.*,i.* from allselect as al,models as mo ,image2 as i WHERE al.log_id=$logid and al.md_int=mo.md_int and mo.img_id=i.img_id and al.status=0" ;
    ...
    <body>
		...
		<div id="wrapper" class="container">
			...
			<img class="pageBanner" src="themes/images/pageBanner.png" alt="New products" >
				<h4><span>Design Details</span></h4>
			</section>
			<section class="main-content">
				<div class="row">
					<div class="span9">
						<h4 class="title"><span class="text"><strong>Your</strong> Designes</span></h4>
						...
						?>
							...
							<tbody>
								<tr>
									<td><a href="remove2.php?id=<?php echo $rest1['al_id'];?>">Remove</a></td>
										<td><a href="/designershop/designer/images/uploads/<?php echo $rest1['img1'];?>" class="thumbnail" data-fancybox-group="group1" title="Description 1"><img alt="" src="/designershop/designer/images/uploads/<?php echo $rest1['img1'];?>"></a>

										<td>	<strong> <?php echo $rest1['md_name'];?></strong></td>
						...
						<p class="buttons center">
							<!-- <a href = "index.php" class="btn btn-sucess"</a>
							<button class="btn" type="button">Update</button> -->
							<a href = "disdetails.php" class="btn btn-sucess"</a>
