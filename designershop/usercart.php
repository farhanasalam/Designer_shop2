...
require 'connect.php';
echo $qry5="SELECT * from disdetails as di,cart as ca,city as c,district as d,state as s WHERE di.read_id=ca.read_id and c.c_id=di.c_id and s.st_id=d.st_id and d.dis_id=c.dis_id " ;
