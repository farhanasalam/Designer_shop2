...
<?php
require 'connect.php';
// echo $qry5="SELECT * from  `models` group by desi_id ";
echo $qry5="SELECT mo.md_int,mo.desi_id,mo.md_name,i.img1,i.img2,i.img3 FROM image2 as i,models as mo where  mo.desi_id=i.desi_id and mo.img_id=i.img_id  group by desi_id ";
						...
						?>
							<li class="span3">
								<div class="product-box">
									...
									<p><a href="design_detail.php?id=<?php echo $rest1['desi_id'];?>"><img width='200px' height='200px' src="/designershop/designer/images/uploads/<?php echo $rest1['img1'];?>" alt="" /></a></p>
										<a href="design_detail.php?id=<?php echo $rest1['desi_id'];?>" class="title"><?php echo $rest1['md_name'];?></a><br/>
									<!-- <a href="pr_detail.php" class="title">Fusce id molestie massa</a><br/>
